namespace Before.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public ActionResult CurrentConnectionsLarge(Guid? id, int? page, int? pageSize)
        {
            ...
            var pageVm = AsyncHelpers.RunSync<DashCurrentConnectionsLargeViewModel>(() => BlobQueryManager.GetDashCurrentConnectionsLargeViewModelAsync(searchUsingId, page.Value, pageSize.Value));
        ...
        public ActionResult DevicesLarge(Guid? id, int? page, int? pageSize)
        {
            ...
            var pageVm = AsyncHelpers.RunSync<DashDevicesLargeViewModel>(() => BlobQueryManager.GetDashDevicesLargeViewModelAsync(searchUsingId, page.Value, pageSize.Value));
