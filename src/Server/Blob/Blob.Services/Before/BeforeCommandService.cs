...
namespace Blob.Services.Before
{
    ...
    public class BeforeCommandService : IBlobCommandManager
    {
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "device", Operation = "register")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "performance", Operation = "add")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "status", Operation = "add")]
