...
using Blob.Security.Permissions;
...
namespace Blob.Services.Before
{
    ...
    public class BeforeQueryService : IBlobQueryManager
    {
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "customer", Operation = "disable")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "customer", Operation = "enable")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "customer", Operation = "view")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "customer", Operation = "update")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "device", Operation = "issueCommand")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "device", Operation = "disable")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "device", Operation = "enable")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "device", Operation = "view")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "device", Operation = "update")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "performance", Operation = "delete")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "performance", Operation = "view")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "status", Operation = "delete")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "status", Operation = "view")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "user", Operation = "disable")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "user", Operation = "enable")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "user", Operation = "view")]
        ...
        [OperationBehavior]
        [BlobPermission(SecurityAction.Demand, Resource = "user", Operation = "update")]
