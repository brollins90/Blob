...
namespace Blob.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BlobDbContext>
    {
        ...
        private void AddCustomers(BlobDbContext context)
        {
            // Customers
        ...
        private void AddBlobPermissions(BlobDbContext context)
        {
        ...
        private void AddDeviceTypes(BlobDbContext context)
        {
            // DeviceTypes
