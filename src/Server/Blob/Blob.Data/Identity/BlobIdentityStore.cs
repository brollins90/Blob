...
namespace Blob.Managers.Security
{
    public class BlobIdentityStore :
        IIdentityStoreService
    {
        ...
        public Task<IdentityResultDto> CreateAsync(UserDto user)
        {
            throw new NotImplementedException();
        }

        public Task<IdentityResultDto> UpdateAsync(UserDto user)
        {
            throw new NotImplementedException();
        }

        public Task<IdentityResultDto> DeleteAsync(string userId)
        {
            throw new NotImplementedException();
        }
        ...
        Task<UserDto> IUserStoreService<string>.FindByNameAsync(string userName)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IdentityResultDto> SetEmailConfirmedAsync(string userId, bool confirmed)
        {
            throw new NotImplementedException();
        }

        Task<UserDto> IUserEmailStoreService<string>.FindByEmailAsync(string email)
        {
            throw new NotImplementedException();
        }
        ...
        Task<UserDto> IUserLoginStoreService<string>.FindAsync(UserLoginInfoDto login)
        {
            throw new NotImplementedException();
        }

        public Task<IdentityResultDto> SetPasswordHashAsync(string userId, string passwordHash)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IdentityResultDto> SetPhoneNumberConfirmedAsync(string userId, bool confirmed)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IdentityResultDto> AddToRoleAsync(string userId, string roleName)
        {
            throw new NotImplementedException();
        }

        public Task<IdentityResultDto> RemoveFromRoleAsync(string userId, string roleName)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IdentityResultDto> SetSecurityStampAsync(string userId, string stamp)
        {
            throw new NotImplementedException();
        }
