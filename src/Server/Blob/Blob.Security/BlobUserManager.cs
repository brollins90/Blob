...
namespace Blob.Security
{
    ...
    //    #region UserManager
        ...
        /// </summary>
        /// <returns></returns>
        public new virtual Task<User> FindAsync(UserLoginInfoDto login)
        {
            ThrowIfDisposed();
        ...
        /// <returns></returns>
        public new virtual async Task<IdentityResultDto> RemoveLoginAsync(Guid userId, UserLoginInfoDto login)
        {
            ThrowIfDisposed();
        ...
        /// <param name="login"></param>
        /// <returns></returns>
        public new virtual async Task<IdentityResultDto> AddLoginAsync(Guid userId, UserLoginInfoDto login)
        {
            ThrowIfDisposed();
            var loginStore = GetLoginStore();
            if (login == null)
